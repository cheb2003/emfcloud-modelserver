 ...
 * </p>
 * <ul>
 *   <li>{@link com.xnzk.flash.meta.impl.NamedImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NamedImpl extends MinimalEObjectImpl.Container implements Named {
    ...
    protected EClass eStaticClass() {
        return MetaPackage.Literals.NAMED;
    }
    ...
    public void setName(String newName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, MetaPackage.NAMED__NAME, oldName, name));
    }
