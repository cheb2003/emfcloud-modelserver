...
public abstract class AbstractOfflineExampleServer {
    ...
    static {
        ...
        TenantPackage.eINSTANCE.getClass(); // Register EPackage in standalone
    }
    ...
    public void init() {
        ...
        repository.setInitialPackages(TenantPackage.eINSTANCE);
    ...
    protected IStore createStore() {
        ...
        h2DataSource.setURL("jdbc:h2:database/" + name);

        final String DATABASE_NAME = name;
...
//        final String DATABASE_NAME = "cdo";
//        final String DATABASE_USER = "root";
//        final String DATABASE_PASS = "123456";
//
...
//        myDataSource.setPort(3307);
//        myDataSource.setServerName("localhost");
//        DataSource dataSource = new P6DataSource(myDataSource);
        DataSource dataSource = new P6DataSource(h2DataSource);
        IMappingStrategy mappingStrategy = CDODBUtil.createHorizontalMappingStrategy(true, true);
